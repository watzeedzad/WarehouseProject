                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> 
                                    <div class="form-group">
                                        <input  onkeyup="NumChk()" id ="num1" type="number" min="1" style="width: 100px; text-align: center" class="form-control" id="usr">
                                    </div>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="form-group">
                                    <input  onkeyup="NumChk()" id ="num2" type="number" min="1"  value="${it.value.quantity}" name="_${it.key}" 
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="form-group">
                                    <input onkeyup="NumChk()" id ="num3" type="number" min="1" value="${it.value.quantity}" name="_${it.key}" 
                                           style="width: 50px; text-align: center"/> 
                                    </div>
                                </td>
                            </tr>
