...
public class EchoServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        String tmp = getInitParameter("foreground");
        if(tmp != null){
            fg = tmp;
        }
        tmp = getInitParameter("background");
        if(tmp != null){
            bg = tmp;
        }
    }
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         //out.println("<a href='echo.html'>BACK</a>");
         out.println("<hr><a href='echo.html'>Entry Form</a>");
   ...
   //@Override
     ...
     * @param req
     * @param res
     * @throws sit.int303.demo.controller.ServletExceptionstatic
     * @throws ServletExceptionstatic
     * @throws IOException
     */
